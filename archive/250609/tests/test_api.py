...
#    """All public objects in the internal API are exposed under `gitman`."""
#    not_exposed = [
#        obj.path
#        for obj in modulelevel_internal_objects
#        if obj.name not in gitman.__all__ or not hasattr(gitman, obj.name)
#    ]
...
def test_single_locations(public_api: griffe.Module) -> None:
    ...
    multiple_locations = {}
    for obj_name in gitman.__all__:
